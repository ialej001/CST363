...
class Row:
    def __init__(self, schema, data):
        ...
        if type(data) == str:
            ...
            print("Error. data is not rawdata or is not a tuple or list with number of values defined in schema",
                  type(data), len(self.schema.cols))
            return
